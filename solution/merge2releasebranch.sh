...
devbranchnameweb=develop
rel1branchname=release/1.0
echo " >>>the current date is ->$seldate"
echo " >>>> the rel1branchname is ->$rel1branchname,>>>> the devbranchnameweb is ->$devbranchnameweb"
cd cw-hms-web/
echo "#########>>>checkout to dev branch for web"
git checkout $devbranchnameweb
git pull
...
git merge --no-ff $devbranchnameweb &&
git add .
